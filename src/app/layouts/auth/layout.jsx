    ...
    <main className="bg-main-light-primary dark:bg-main-dark-primary flex min-h-screen">
      <div className="flex flex-1 flex-col items-center justify-center bg-main-gradient xl:rounded-br-xl xl:rounded-tr-xl">
        <Image
          ...
          priority
        />
        <div className="hidden rounded-3xl border-2 dark:border-main-dark-secondary bg-main-light-primary dark:bg-main-dark-secondary dark:!text-white px-8 max-sm:px-4 py-12 max-xl:block max-md:w-[calc(100%-2rem)] max-sm:mb-4">
          {children}
        </div>
      </div>
